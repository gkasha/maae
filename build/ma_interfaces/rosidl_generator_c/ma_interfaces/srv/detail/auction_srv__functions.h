...
#ifndef MA_INTERFACES__SRV__DETAIL__AUCTION_SRV__FUNCTIONS_H_
#define MA_INTERFACES__SRV__DETAIL__AUCTION_SRV__FUNCTIONS_H_
...
/// Initialize srv/AuctionSrv message.
/**
...
/// Finalize srv/AuctionSrv message.
/**
...
/// Create srv/AuctionSrv message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ma_interfaces__srv__AuctionSrv_Request__init().
...
/// Destroy srv/AuctionSrv message.
/**
 * It calls
 * ma_interfaces__srv__AuctionSrv_Request__fini()
...
/// Check for srv/AuctionSrv message equality.
/**
...
/// Initialize array of srv/AuctionSrv messages.
/**
...
/// Finalize array of srv/AuctionSrv messages.
/**
 * It calls
 * ma_interfaces__srv__AuctionSrv_Request__fini()
...
/// Create array of srv/AuctionSrv messages.
/**
 * It allocates the memory for the array and calls
 * ma_interfaces__srv__AuctionSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AuctionSrv messages.
/**
 * It calls
 * ma_interfaces__srv__AuctionSrv_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AuctionSrv message array equality.
/**
...
/// Copy an array of srv/AuctionSrv messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ma_interfaces__srv__AuctionSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ma_interfaces
...
/**
 * It calls
 * ma_interfaces__srv__AuctionSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ma_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ma_interfaces__srv__AuctionSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ma_interfaces
...
/**
 * It calls
 * ma_interfaces__srv__AuctionSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MA_INTERFACES__SRV__DETAIL__AUCTION_SRV__FUNCTIONS_H_
