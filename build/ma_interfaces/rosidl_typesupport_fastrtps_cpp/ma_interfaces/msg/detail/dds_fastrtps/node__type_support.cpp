...
#include "ma_interfaces/msg/detail/node__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ma_interfaces::msg::Node *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ma_interfaces::msg::Node *>(
    untyped_ros_message);
...
{
  return &ma_interfaces::msg::typesupport_fastrtps_cpp::_Node__handle;
}
