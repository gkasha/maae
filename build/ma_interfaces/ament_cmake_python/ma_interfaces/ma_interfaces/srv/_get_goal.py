...
class Metaclass_GetGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ma_interfaces.srv import _get_goal
...
class GetGoal(metaclass=Metaclass_GetGoal):
    from ma_interfaces.srv._get_goal import GetGoal_Request as Request
    from ma_interfaces.srv._get_goal import GetGoal_Response as Response
