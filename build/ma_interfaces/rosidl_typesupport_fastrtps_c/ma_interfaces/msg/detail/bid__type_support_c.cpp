...
#include "ma_interfaces/msg/detail/bid__rosidl_typesupport_fastrtps_c.h"
...
using _Bid__ros_msg_type = ma_interfaces__msg__Bid;
...
static uint32_t _Bid__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ma_interfaces__msg__Bid(
...
static size_t _Bid__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ma_interfaces__msg__Bid(
