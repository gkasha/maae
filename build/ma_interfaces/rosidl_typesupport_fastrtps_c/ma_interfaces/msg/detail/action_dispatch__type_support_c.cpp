...
#include "ma_interfaces/msg/detail/action_dispatch__rosidl_typesupport_fastrtps_c.h"
...
using _ActionDispatch__ros_msg_type = ma_interfaces__msg__ActionDispatch;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ActionDispatch__ros_msg_type * ros_message = static_cast<const _ActionDispatch__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _ActionDispatch__ros_msg_type * ros_message = static_cast<_ActionDispatch__ros_msg_type *>(untyped_ros_message);
  // Field name: action_id
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_ma_interfaces__msg__ActionDispatch(
  const void * untyped_ros_message,
...
static uint32_t _ActionDispatch__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ma_interfaces__msg__ActionDispatch(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ma_interfaces
size_t max_serialized_size_ma_interfaces__msg__ActionDispatch(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _ActionDispatch__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ma_interfaces__msg__ActionDispatch(
...
static message_type_support_callbacks_t __callbacks_ActionDispatch = {
  "ma_interfaces::msg",
  "ActionDispatch",
...
static rosidl_message_type_support_t _ActionDispatch__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ActionDispatch,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ma_interfaces, msg, ActionDispatch)() {
  return &_ActionDispatch__type_support;
}
