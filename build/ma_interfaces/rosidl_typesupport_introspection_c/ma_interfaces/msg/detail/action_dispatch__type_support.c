...
static rosidl_typesupport_introspection_c__MessageMember ma_interfaces__msg__ActionDispatch__rosidl_typesupport_introspection_c__ActionDispatch_message_member_array[7] = {
  {
    "action_id",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ma_interfaces__msg__ActionDispatch, execution_range),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
