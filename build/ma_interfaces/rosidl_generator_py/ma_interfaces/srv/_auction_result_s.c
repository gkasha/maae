...
bool ma_interfaces__srv__auction_result__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ma_interfaces.srv._auction_result.AuctionResult_Request", full_classname_dest, 55) == 0);
  }
  ma_interfaces__srv__AuctionResult_Request * ros_message = _ros_message;
  {  // t
...
{
  /* NOTE(esteve): Call constructor of AuctionResult_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ma_interfaces.srv._auction_result");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AuctionResult_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool ma_interfaces__srv__auction_result__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ma_interfaces.srv._auction_result.AuctionResult_Response", full_classname_dest, 56) == 0);
  }
  ma_interfaces__srv__AuctionResult_Response * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of AuctionResult_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ma_interfaces.srv._auction_result");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AuctionResult_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
