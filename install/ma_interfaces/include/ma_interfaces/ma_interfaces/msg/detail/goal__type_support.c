...
static rosidl_typesupport_introspection_c__MessageMember ma_interfaces__msg__Goal__rosidl_typesupport_introspection_c__Goal_message_member_array[1] = {
  {
    "name",  // name
    ...
    offsetof(ma_interfaces__msg__Goal, name),  // bytes offset in struct
    NULL,  // default value
