...
{
  new (message_memory) ma_interfaces::msg::Bid(_init);
}

void Bid_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ma_interfaces::msg::Bid *>(message_memory);
  typed_message->~Bid();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Bid_message_member_array[5] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ma_interfaces::msg::Bid, st),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ma_interfaces::msg::Bid, et),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ma_interfaces::msg::Bid, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::ma_interfaces::msg::rosidl_typesupport_introspection_cpp::Bid_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ma_interfaces, msg, Bid)() {
  return &::ma_interfaces::msg::rosidl_typesupport_introspection_cpp::Bid_message_type_support_handle;
}
