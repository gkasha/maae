...
#ifndef MA_INTERFACES__SRV__DETAIL__ADD_GOAL__FUNCTIONS_H_
#define MA_INTERFACES__SRV__DETAIL__ADD_GOAL__FUNCTIONS_H_
...
/// Initialize srv/AddGoal message.
/**
...
/// Create srv/AddGoal message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ma_interfaces__srv__AddGoal_Request__init().
...
/// Destroy srv/AddGoal message.
/**
 * It calls
 * ma_interfaces__srv__AddGoal_Request__fini()
...
/// Check for srv/AddGoal message equality.
/**
...
/// Initialize array of srv/AddGoal messages.
/**
...
/// Finalize array of srv/AddGoal messages.
/**
 * It calls
 * ma_interfaces__srv__AddGoal_Request__fini()
...
/// Create array of srv/AddGoal messages.
/**
 * It allocates the memory for the array and calls
 * ma_interfaces__srv__AddGoal_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AddGoal messages.
/**
 * It calls
 * ma_interfaces__srv__AddGoal_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AddGoal message array equality.
/**
...
/// Copy an array of srv/AddGoal messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ma_interfaces__srv__AddGoal_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ma_interfaces
...
/**
 * It calls
 * ma_interfaces__srv__AddGoal_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ma_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ma_interfaces__srv__AddGoal_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ma_interfaces
...
/**
 * It calls
 * ma_interfaces__srv__AddGoal_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MA_INTERFACES__SRV__DETAIL__ADD_GOAL__FUNCTIONS_H_
